...
test("splice", function() {
    ...
    ok(workingWeek.equalTo(['Monday', 'Tuesday', 'Wednesday', 'Thursday']), 'what is the value of workingWeek?');
    ok(daysOfWeek.equalTo(['Friday', 'Saturday', 'Sunday']), 'what is the value of daysOfWeek?');
});
